...
export function ContactUs () {
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      <AuthHeader label={translate('contactus.contactus')} onPress={() => navigation.goBack()} />
        ...
        <ScrollView
          ...
          <InputText
            ...
            onChangeText={(text: string) =>
              setname(text.replace(/[^a-z.A-Z]/g, ''))
            }
            maxLength={500}
            multiline
